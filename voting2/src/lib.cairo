...
trait DatabaseTrait<T> {
    ...
    fn delete_book(ref self:T,title:felt252);
}
...
student_3:ContractAddress){
    ...
    let mut arrCon:Array<felt252> = ArrayTrait::new();

    arrCon.append(book1.Title);
    arrCon.append(book2.Title);
    arrCon.append(book3.Title);
    arrCon.append(book4.Title);
    arrCon.append(book5.Title);

    self.arr.write(arrCon);
}
...
impl DataBaseTraitImpl of super::DatabaseTrait<ContractState>{
    ...
    fn search_book(self:@ContractState,key:Book)->felt252{
     ...
     fn delete_book(ref self:ContractState,title:felt252){
         //let del_book = Book{Title:title};
         let mut arr3:Array<felt252> = ArrayTrait::new();
         arr3 = self.arr.read();
     }
}
